  ...
  return (
    <>
      <div className="bg-[#F7FCFE] lg:py-[85px] py-10 relative overflow-hidden">
        <img
          className="absolute pointer-events-none top-[7%] start-0 sm:w-[10%] md:w-[10%] lg:w-[7%] xxl:w-[unset] hidden sm:block"
          src={dotsImg}
          alt="dots-img"
        />
        <img
          className="absolute pointer-events-none bottom-[-8%] end-0"
          src={smallImg}
          alt="dots-img"
        />
        <div className="container xl:max-w-[1140px] 3xl:max-w-[1320px] mx-auto px-5 xl:px-0">
          <div className="flex flex-wrap justify-between items-center">
            ...
            <div className="lg:w-5/12 lg:pe-[41px]">
              <h2
                className="ff_railway text-lightBlack lg:text-xl md:text-[36px] sm:text-[34px] text-[30px] font-medium leading-normal mb-0 lg:mb-[14px] inline-block pt-8 lg:pt-0
              relative before:absolute before:h-1 before:w-full before:rounded before:bg-[#2ABAE9]  lg:before:top-[-3%] before:content-[''] before:start-0"
              >
                Our Mission
              </h2>
