        ...
        <div className="container xl:max-w-[1140px] 3xl:max-w-[1320px] mx-auto px-5 xl:px-0">
          <div className="flex flex-wrap justify-between items-center">
            <div className="lg:w-6/12 sm:w-9/12 mx-auto lg:mx-[unset]">
              <img className="lg:h-[481px] lg:w-[534px] w-full" src={mission} alt="about-mission" />
            </div>
            <div className="lg:w-5/12 lg:pe-[41px]">
              ...
              relative before:absolute before:h-1 before:w-full before:rounded before:bg-[#2ABAE9]  lg:before:top-[-3%] before:content-[''] before:start-0">Our Mission</h2>
