              ...
              <div
                ...
                <div className='border pt-[30px] cursor-pointer pb-[28px] border-[#E5E5E5] rounded-[14px] plan_card group hover:bg-planCard h-full flex items-center flex-col justify-between min-h-[480px] lg:min-h-[570px]'>
                  <div>
                    ...
                    <p className='text-center mb-[6px] 2xl:text-base ff_inter text-sm text-black font-normal leading-normal  opacity-50 group-hover:text-white group-hover:opacity-[1]'>{MyData.priceBottomPara}</p>
                    <div>
                  ...
                  <button
                    className="ff_inter mt-[36px] font-medium 2xl:text-[22px] text-md bg-btnGradient group-hover:text-black  group-hover:bg-gradient-to-t from-white to-white text-white h-[45px] lg:h-[48px] w-[200px] lg:w-[220px] xl:w-[270px] rounded-[122px]"
                  >
                     {MyData.mybutton}
                  </button>
                </div>
