  ...
  return (
    <>
      <div className="relative w-full">
        ...
        />
        <div className="container xl:max-w-[1140px] 3xl:max-w-[1320px] mx-auto px-5 xl:px-0 lg:mt-28 lg:mb-[100px] mb-[40px] mt-16">
          <div className="flex flex-wrap xl:flex-row flex-col items-center ">
            <div className="xl:w-[35%] md:w-6/12 w-full flex flex-col justify-center ">
              <div className="bg-[url('./assets/svg/millionPink.svg')] bg-no-repeat bg-center bg-contain 2xl:py-2 xl:py-5 pe-16 xl:translate-x-[25px]">
                ...
                <p className="ff_outfit text-center font-semibold sm:text-md 2xl:text-[22px] text-[15px] leading-[125%] text-white">
                  Million
                </p>
                <p className="text-center text-white sm:text-md 2xl:text-[22px] text-[15px] font-light leading-[135%] pb-2 ff_outfit">
