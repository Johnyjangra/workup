  ...
  return (
    <>
      <div className="relative w-full">
        ...
        />
        <img src={BottomDot} alt="BottomDot" className="absolute bottom-0 start-0 lg:block hidden pointer-events-none" />
        <div className="container xl:max-w-[1140px] 3xl:max-w-[1320px] mx-auto px-5 xl:px-0 md:py-32 sm:py-20 pt-20 pb-16">
          <div className="flex flex-wrap items-center justify-between lg:flex-row flex-col-reverse">
            <div className="lg:w-5/12 w-full lg:mt-0 mt-10">
              <p className="ff_outfit font-medium lg:text-xl md:text-[36px] sm:text-[34px] text-[30px] text-Black leading-normal relative after:contents-[''] after:absolute after:w-[160px] after:start-0 after:h-[4px]  after:rounded-md after:bg-blue after:top-[-6%] mb-0">
                Business Model
              </p>
              ...
              <p className="ff_inter text-xs sm:text-sm font-normal leading-[160%] text-[#4D4D4D] lg:max-w-[451px]">
