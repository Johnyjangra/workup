  ...
  return (
    <div className="relative">
      ...
      <img
        src={dots}
        alt="dots"
        className=" absolute start-0 bottom-0 pointer-events-none"
      />
      <p className="ff_outfit font-normal lg:text-xl 2xl:text-[44px] md:text-[36px] sm:text-[34px] text-[30px] text-Black leading-normal relative after:contents-[''] after:absolute after:w-[160px] after:start-[50%] after:translate-x-[-50%] after:h-[4px]  after:rounded-md after:bg-blue after:top-[-4%] mb-0 text-center">
        WorkUp Team
      </p>
      <div className="container xl:max-w-[1140px] 3xl:max-w-[1320px] mx-auto px-5 xl:px-0 lg:mt-20 sm:mt-10 mt-5 lg:mb-[280px] sm:mb-[200px] mb-[100px]">
        <div className="flex flex-wrap items-center lg:justify-between justify-center">
          ...
          <div className="lg:w-6/12 w-full lg:mt-0 mt-5 relative z-10 xl:pb-0 sm:pb-10">
            ...
            <p className=" text-xs sm:text-sm 2xl:text-[18px]font-normal leading-[160%] text-[#4D4D4D] mt-1 ff_inter">
            ...
            <p className="text-black ff_outfit sm:text-md text-[18px] 2xl:text-[22px] font-medium leading-[160%]">
              Luke Howard
            </p>
            <p className="text-black ff_outfit text-base 2xl-[20px] font-normal leading-[140%] mt-[-4px]">
              Founder
            </p>
          </div>
        </div>
