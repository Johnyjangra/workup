          ...
          <div className="w-full md:w-[350px]">
            ...
            <form>
              <input
                type="text"
                required
                className="p-4 bg-[rgba(255,255,255,0.20)] rounded-lg md:w-[350px] w-full text-[#EEECFD] text-sm placeholder:text-sm font-normal placeholder:font-normal border-[#CBC7FA] border focus-visible:outline-none placeholder:text-[#EEECFD] h-[52px]"
