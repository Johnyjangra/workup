  ...
  return (
    <div className="bg-[url('./assets/webp/BrandHeroBg.webp')] bg-no-repeat bg-cover">
      ...
      <div className="container xl:max-w-[1140px] 3xl:max-w-[1320px] mx-auto px-5 xl:px-0 pb-[80px] sm:pb-[95px]">
        ...
        <form className="bg-white h-[44px] sm:h-[52px] w-full max-w-[464px] mx-auto rounded-[100px] ps-[22px] flex items-center justify-between mt-4 input_border_gradient">
              <input
                required
              ...
              />
              <button className="bg-gradientOne group h-[32px] sm:h-[36px] min-w-[70px] rounded-[100px] flex justify-center items-center sm:mx-2 mx-1 mt-[1px]">
                <img
