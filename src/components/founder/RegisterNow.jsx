  ...
  return (
    <>
      <div className="lg:pt-[111px] py-12 xl:pb-[105px] relative">
        <img
          className="absolute top-0 start-0 hidden xl:block"
          src={left_top}
          alt=" dots with circle"
        />
        <img
          className="absolute start-0 bottom-[30%] w-[6%] hidden xl:block"
          src={left_bottom}
          alt="semicircle"
        />
        <img
          className="absolute end-0 top-[60%] w-[8%] hidden xl:block"
          src={right_img}
          alt="dots with circle"
        />
        <div className="container 2xl:max-w-[1320px] xl:max-w-[1140px] mx-auto px-5 xl:px-0">
          <form
            ...
            <img
              className="absolute end-[-3%] top-[40%] z-[-2] hidden lg:block"
              src={dots_group}
              alt="dots group"
            />
